            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12">
                    ...
                    <div className="space-y-6 sm:space-y-8" data-aos="fade-right" data-aos-duration="1000">
                        <div>
                            <h2 className="text-xl sm:text-2xl font-bold text-gray-800 dark:text-white mb-3 sm:mb-4">Get in Touch</h2>
                        ...
                        <div className="space-y-3 sm:space-y-4">
                            ...
                            <div className="flex items-start">
                                ...
                                <div className="ml-3 sm:ml-4">
                                    <h3 className="text-base sm:text-lg font-medium text-gray-800 dark:text-white">Address</h3>
                                    <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300">Pangsha, Rajbari, Dhaka, Bangladesh</p>
                                </div>
                            </div>
                        </div>

                        <div>
                            <h3 className="text-base sm:text-lg font-medium text-gray-800 dark:text-white mb-3 sm:mb-4">Connect with me</h3>
                            <div className="flex space-x-4">
                                <a href="https://www.facebook.com/abir.neu/" className="text-gray-600 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400">
                                ...
                                <a href="#" className="text-gray-600 hover:text-blue-400 dark:text-gray-300 dark:hover:text-blue-400">
                                    <span className="sr-only">Twitter</span>
                                    <svg className="h-5 w-5 sm:h-6 sm:w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                  </svg>
                </a>
                <a href="https://github.com/abirneu" className="text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                ...
                <a href="https://www.linkedin.com/in/abir-hasan-8812051a0" className="text-gray-600 hover:text-blue-700 dark:text-gray-300 dark:hover:text-blue-400">
