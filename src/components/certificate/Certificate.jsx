...
const Certificate = () => {
  ...
  return (
    <section className="py-2 px-2 sm:px-4 md:px-8 bg-secondary dark:bg-gray-900">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="mb-4 sm:mb-6 text-center">
          <div>
            ...
            >
              <div className="text-3xl sm:text-6xl xl:text-7xl font-bold text-gray-200 dark:text-gray-700 mb-4">
                ACHIEVEMENTS
              </div>
              <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold dark:text-white absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                My Certificates
              </h1>
            </div>
          </div>
            ...
            >
              ...
              >
                <img
                  src={cert.image}
                  alt={cert.title}
                  className="w-full h-40 sm:h-48 lg:h-52 object-cover transition-transform duration-500 group-hover:scale-105"
                />
              ...
              <div className="p-4 sm:p-6">
                <h3 className="text-lg sm:text-xl font-bold text-gray-800 dark:text-white mb-2 group-hover:text-primary dark:group-hover:text-primary transition-colors">
                  {cert.title}
                </h3>
                ...
                <button
                  onClick={() => openModal(cert)}
                  className="mt-3 sm:mt-4 w-full py-2 text-sm sm:text-base text-center text-black dark:text-white border border-primary dark:border-primary/60 rounded-lg hover:bg-primary hover:text-white dark:hover:bg-primary dark:hover:text-gray-900 transition-colors duration-300"
                >
                  View Certificate
                </button>
              </div>
                  ...
                  <div className="p-4 sm:p-6">
                    ...
                    <div className="mt-4 sm:mt-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                      ...
                      <a
                        ...
                        className="w-full sm:w-auto px-4 py-2 text-center text-sm sm:text-base bg-primary hover:bg-primary/80 text-white rounded-lg transition-colors duration-300"
                      >
                        Verify Credential
                      </a>
                    </div>
